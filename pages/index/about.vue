...
zh:
  ...
  descDegree: |
    ...
    目前專職遊戲開發，Unity工程師，Godot新手，正在學習遊戲設計。
  descKnowLang: |
...
<template>
  <div id="about">
    ...
    <p>{{ $t("descKnowLang") }}</p>
    <h2>{{ $t("supportme") }}</h2>
    <a href="https://ko-fi.com/puetsua"
      ><img src="@/assets/BuyMeACoffee_Red@2x.png" height="50px"
    /></a>
    <p>{{ $t("supportdesc") }}</p>
    <h2>{{ $t("contactme") }}</h2>
    ...
    /></a>
    <a
      href="https://www.youtube.com/channel/UCtAVtsEW_OHh4X7yWjOVoLQ"
      target="_blank"
